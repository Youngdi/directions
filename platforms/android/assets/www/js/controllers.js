...
.controller('HomeCtrl', function($ionicPopover, $rootScope, $cordovaDevice, $ionicLoading, $ionicPlatform, $scope, $ionicPopup, $cordovaStatusbar, $cordovaSQLite, $http, $cordovaFile, SQL) {
    ...
    //     var query = "SELECT h_where FROM article_cht WHERE h_where = '001'";
    //     $scope.data1 = SQL.search(query);
    //     console.log(data1);
    // };


    // $scope.lesson = function(signal) {
    //     alert("A");
    //     $('.bar-header').removeClass('bar-positive');
    //     $('.bar-header').addClass('bar-royal');
    //     $('.tabs-icon-top').removeClass('tabs-positive');
    //     $('.tabs-icon-top').addClass('tabs-royal');
    //     if (signal === true) {
    //         myPopup.close();
    //     } else {
    ...
    //     }
    // };
    // $scope.select_cht = function(user) {
    //     var query = "SELECT * FROM article_cht WHERE h_where = 1000";
    //     $cordovaSQLite.execute(db, query).then(function(res) {
    //         $scope.lesson_data = [];
    //         var lesson_data = [];
    //         for (i = 0; i < res.rows.length; i++) {
    ...
    //     });
    // };
    // $scope.select_en = function(user) {
    //     var query = "SELECT * FROM article_en WHERE h_where = 1000";
    //     $cordovaSQLite.execute(db, query).then(function(res) {
    //         $scope.lesson_data = [];
    //         var lesson_data = [];
    //         for (i = 0; i < res.rows.length; i++) {
